...
- Developing a small dashboard that simulates a factory environment for processing crop seeds - a bit of a return to my environmental roots, as well as a learning opportunity for manufacturing principles. I'm trying to keep the amount of Python low as that's my most comfortable language, and focus on shell scripting (zsh) and SQL. I'm also learning Tableau as, historically I have mostly used Power BI, Markdown, Shiny, and Plotly as visualization tools. Work in progress. [Crop Manufacturing Simulation](https://github.com/mpdubbin/crop_manufact_sim). 
